public class Game {
    ...
    public boolean checkWeigh(){ // Check the weights of the fighters.
        return (f1.weight >= minWeight && f1.weight <= maxWeight) && (f2.weight >= minWeight && f2.weight <= maxWeight);
    }

    public boolean isWin(){ // Check who is the winner.
        if (f1.health==0){
    ...
    public boolean whoStart(){ // Check who will start the round.
    ...
    public void printScore(){ // Print the scores.
        System.out.println("--------------------------");
